...
/**
 * @author Administrator Created by Callum Holden 28/09/2016
 *
 */
@Entity
...
public class ProductVariants {
	 ...
	 * @param fk_ProductID
	 */
	public ProductVariants(long prodVarId, int stockLevel, double price, boolean porous, String status,
			long fk_ProductID) {
