 ...
 * Interface for Purchase Order Lines
 * Provides CRUD outlines for Purchase Order Lines
 *
 */
public interface PurchaseOrderLineRepository {
	/**
	 * 
	 * @param Purchase Order Line
	 ...
	 * 
	 * @param Purchase Order Line
	 * Creates a list of Purchase Order Lines
	 */
	public void createPurchaseOrderLines(List<PurchaseOrderLine> pol);
	/**
	 * 
	 * @return An arraylist of Purchase Order Lines
	 * Reads Purchase Order Lines from the database
	 */
